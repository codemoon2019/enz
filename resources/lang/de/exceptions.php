    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Dein Benutzerkonto ist nicht aktiviert. Bitte klicke auf den Link in der Aktivierungsmail, oder <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_uuid') . '">klicke hier</a> um die Aktivierungsmail erneut zu senden.',
