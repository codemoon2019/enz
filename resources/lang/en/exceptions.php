    ...
    'backend' => [
        'access' => [
            'roles' => [
                ...
                'cant_delete_admin' => 'You can not delete the System role.',
            ...
            'users' => [
                ...
                'cant_delete_admin' => 'You can not delete the super system.',
                'cant_delete_self' => 'You can not delete yourself.',
                'cant_delete_own_session' => 'You can not delete your own session.',
                'cant_restore' => 'This user is not deleted so it can not be restored.',
                'cant_unconfirm_admin' => 'You can not un-confirm the super system.',
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_uuid') . '">click here</a> to resend the confirmation e-mail.',
