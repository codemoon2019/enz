    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Su cuenta no ha sido verificada todavía. Por favor, revise su e-mail, o <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_uuid') . '">pulse aquí</a> para re-enviar el correo de verificación.',
