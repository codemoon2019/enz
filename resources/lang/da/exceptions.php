    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Din konto er ikke bekræftet. Klik på linket i bekræftelsesmailen eller <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_uuid') . '">klik her</a> for at gensende bekræftelsesmailen.',
