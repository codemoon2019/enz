    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Uw account kon niet worden bevestigd. Klik op de informatie link in de email die u heeft ontvangen, of <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_uuid') . '">klik hier</a> om de bevestigingsemail opnieuw te versturen.',
