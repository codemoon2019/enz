    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Din konto er ikke bekreftet. Klikk på linket i bekreftelsesmailen eller <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_id') . '">klikk her</a> for å sende den på nytt.',
