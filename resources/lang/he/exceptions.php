    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'החשבון שלך לא אומת. יש להקליק על הקישור לאימות בדוא"ל שלך, או <a href="' . route('frontend.auth.account.confirm.resend',
                        ':user_uuid') . '"> להקליק כאן</a> כדי לשלוח מייל אימות חדש.',
