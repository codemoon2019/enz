<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarLogviewerLinks"
            aria-controls="navbarLogviewerLinks" aria-expanded="false" aria-label="Toggle navigation">
