            ...
            <div class="card card-table" style="padding-bottom: 20px;">
                ...
                <div class="col-sm-12">
                    ...
                    <h4 class="card-title mb-0" style="padding-top: 10px;">
                        ...
                        <a href="{{ route('admin.more-lives.create') }}">
                        ...
                        <ol class="dd-list">
                            ...
                            @foreach ($moreLife as $key => $item)
                                ...
                                @include('backend.includes.sortable.list', [
                                    ...
                                    'edit_route' => route('admin.more-lives.edit', $item->slug),
                                    
                                    'delete_route' => route('admin.more-lives.destroy', $item->slug)
