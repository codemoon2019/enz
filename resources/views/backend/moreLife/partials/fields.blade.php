    ...
    <div class="col">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                ...
                <input type="text" name="url" class="form-control" value="{{ isset($model) ? $model->url : old('url') }}" placeholder="Optional">
            ...
            <div class="col-md-10">
                @if(isset($model))
                    ...
                    <image-uploader
                        :api-mode="true"
                        :multiple="true"
                        :uploads="{{ json_encode($model->getUploaderImages('banners', 'thumbnail')) }}"
                        :upload-url="{{ json_encode(route('webapi.admin.image.upload', ['model' => 'more-life', 'routeKeyValue' => $model->slug, 'collection' => 'banners'])) }}"
                    ></image-uploader>
            ...
            <div class="col-md-10">
                @if(isset($model))
                    ...
                    <image-uploader
                        ...
                        :upload-url="{{ json_encode(route('webapi.admin.image.upload', ['model' => 'more-life', 'routeKeyValue' => $model->slug, 'collection' => 'featured'])) }}"
                    ></image-uploader>
