...
<div class="container-fluid px83">
    ...
    <section class="mycustom-slick right-slick relative mb150"  id="myslick2">
        ...
        <div class="row">
            ...
            <div class="col-sm-1 text-center slick-controller">
                ...
                <div class="slick-custom-nav">
                    ...
                    <span class="right">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.72 26.03">
            ...
            <div class="col-sm-5 left-content">
                ...
                <h2 class="title text-black mb30">{{ $data->title }}</h2>
