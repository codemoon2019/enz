        ...
        <div class="container-fluid px180 relative">
            ...
            <div class="row">
                <div class="col-sm-3 item mb40">
                    <div class="card">
                        <div class="card-header p0">
                            <img class="img-fluid" src="{{asset('img/news/news1.jpg')}}" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">The best jobs in Australia for 2018</h3>
                            <p class="card-text">Aug 31, 2018</p>
                ...
                <div class="col-sm-3 item mb40">
                    <div class="card">
                        <div class="card-header p0">
                            <img class="img-fluid" src="{{asset('img/news/news2.jpg')}}" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Nursing in Australia vs. UK</h3>
                            <p class="card-text">Aug 31, 2018</p>
                            <a href="#" class="read-more text-blue text-uppercase">Read more</a>
                        </div>
                    </div>
                ...
                <div class="col-sm-3 item mb40">
                    <div class="card">
                        <div class="card-header p0">
                            <img class="img-fluid" src="{{asset('img/news/news3.jpg')}}" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">Why Study in Australia?</h3>
                            <p class="card-text">Aug 31, 2018</p>
                            <a href="#" class="read-more text-blue text-uppercase">Read more</a>
                        </div>
                    </div>
                ...
                <div class="col-sm-3 item mb40">
                    <div class="card">
                        <div class="card-header p0">
                            <img class="img-fluid" src="{{asset('img/news/news4.jpg')}}" alt="">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">3 Australian Cities in Top 10 Most Livable Cities in the World</h3>
                            <p class="card-text">Aug 31, 2018</p>
                            <a href="#" class="read-more text-blue text-uppercase">Read more</a>
                        </div>
                    </div>
