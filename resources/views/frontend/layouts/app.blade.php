...
@else
    ...
    <div id="app" class="main-wrapper ">
        ...
        <div class="mag-download fixed-bottom text-center">
            <img class="img-fluid" src="{{asset('svg/book.svg')}}" alt=""> <p class="fs16 text-white book-title">Brand New 2019 Overseas Students Guide</p> 
            <a href="#" class="btn btnview-more text-uppercase">Download now!</a>
        </div>
    </div>

    <button id="top" class="scrollTop btn"><img class="img-fluid" src="{{asset('svg/arrow.svg')}}" alt=""></button>
    <!-- PRELOADING CSS -->
	<script>
