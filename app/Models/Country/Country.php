...
class Country extends Model implements HasMedia
{
    ...
    public function registerMediaCollections()
    {
        ...
        $this->addMediaCollection('capital_icon')->singleFile()->registerMediaConversions(function (Media $media) {

            $this->addMediaConversion('main')
                ->optimize()
                ->format(Manipulations::FORMAT_JPG)
                ->fit(Manipulations::FIT_CROP, 167, 142);
        ...
        $this->addMediaCollection('founded_icon')->singleFile()->registerMediaConversions(function (Media $media) {
        ...
        $this->addMediaCollection('area_icon')->singleFile()->registerMediaConversions(function (Media $media) {
        ...
        $this->addMediaCollection('population_icon')->singleFile()->registerMediaConversions(function (Media $media) {
