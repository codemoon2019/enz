...
use App\Models\Service\Traits\ServiceAttributes;
use App\Models\Service\Traits\ServiceRegularFunctions;
use App\Models\Service\Traits\ServiceRelations;
use App\Models\Service\Traits\ServiceScopes;
use App\Models\Service\Traits\ServiceStaticFunctions;
...
class Service extends Model implements HasMedia
{
    ...
    use ServiceAttributes;
    use ServiceRegularFunctions;
    use ServiceRelations;
    use ServiceScopes;
    use ServiceStaticFunctions;
    use HasImageMediaTrait;
    use CustomAttributes;

    public const MODULE_NAME = 'service';
    public const VIEW_BACKEND_PATH = 'backend.service';
    public const VIEW_FRONTEND_PATH = 'frontend.service';
    public const ROUTE_ADMIN_PATH = 'admin.services';
    public const ROUTE_FRONTEND_PATH = 'frontend.services';
