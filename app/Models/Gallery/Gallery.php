...
use App\Models\Gallery\Traits\GalleryAttributes;
use App\Models\Gallery\Traits\GalleryRegularFunctions;
use App\Models\Gallery\Traits\GalleryRelations;
use App\Models\Gallery\Traits\GalleryScopes;
use App\Models\Gallery\Traits\GalleryStaticFunctions;
...
class Gallery extends Model implements HasMedia
{
    ...
    use GalleryAttributes;
    use GalleryRegularFunctions;
    use GalleryRelations;
    use GalleryScopes;
    use GalleryStaticFunctions;
    use HasImageMediaTrait;
    use CustomAttributes;

    public const MODULE_NAME = 'gallery';
    public const VIEW_BACKEND_PATH = 'backend.gallery';
    public const VIEW_FRONTEND_PATH = 'frontend.gallery';
    public const ROUTE_ADMIN_PATH = 'admin.galleries';
    public const ROUTE_FRONTEND_PATH = 'frontend.galleries';
