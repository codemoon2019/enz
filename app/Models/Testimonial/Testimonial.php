...
use App\Models\Testimonial\Traits\TestimonialAttributes;
use App\Models\Testimonial\Traits\TestimonialRegularFunctions;
use App\Models\Testimonial\Traits\TestimonialRelations;
use App\Models\Testimonial\Traits\TestimonialScopes;
use App\Models\Testimonial\Traits\TestimonialStaticFunctions;
...
/**
 * Class Testimonial
 * @package App\Models\Testimonial
 */
class Testimonial extends Model implements HasMedia
{
    ...
    use TestimonialAttributes;
    use TestimonialRegularFunctions;
    use TestimonialRelations;
    use TestimonialScopes;
    use TestimonialStaticFunctions;
    use HasImageMediaTrait;
    use CustomAttributes;

    public const MODULE_NAME = 'testimonial';
    public const VIEW_BACKEND_PATH = 'backend.testimonial';
    public const VIEW_FRONTEND_PATH = 'frontend.testimonial';
    public const ROUTE_ADMIN_PATH = 'admin.testimonials';
    public const ROUTE_FRONTEND_PATH = 'frontend.testimonials';
