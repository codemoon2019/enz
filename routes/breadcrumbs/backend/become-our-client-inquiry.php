...
$routePath = app(App\Models\BecomeOurClientInquiry\BecomeOurClientInquiry::class)::ROUTE_ADMIN_PATH;

Breadcrumbs::register($routePath . '.index', function ($breadcrumbs) use ($routePath) {
    $breadcrumbs->parent('admin.dashboard');
    $breadcrumbs->push('Become Our Client Inquiry', route($routePath . '.index'));
});
